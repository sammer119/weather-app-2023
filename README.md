...
Geolocation for finding location of user and Preferences API for storing local storage of most recent current Weather data.
...
```
{
  "cwd": "/Users/samatkins/Software Dev/weather-app",
  "type": [
    "capacitor"
  ],
  "name": "Weather App",
